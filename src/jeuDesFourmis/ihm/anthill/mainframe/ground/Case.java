 ...
 * @version 1.0
 * @see Cell
 * @see jeuDesFourmis.ihm.anthill.sideframe.ZoomedGridComponent
 * @see jeuDesFourmis.ihm.anthill.mainframe.gui.component.GridComponent
 */
public class Case extends Cell {
     ...
     * @see GraphicSeed
     */
    private final List<GraphicSeed> listSeed;
     ...
     */
    private void paintAnt(Graphics grid, Fourmi ant) {
    ...
    private void paintSeed(Graphics grid) {
     ...
     */
    private void paintDetailedAnt(Graphics2D grid, Fourmi ant, int translateX, int translateY) {
     ...
     * @param translateY Useful if you zooming, because the origin of the start of the zoom area is not in Y = 0.
     */
    private void paintDetailedSeed(Graphics2D grid, int translateX, int translateY) {
        // Origin of a cell.
        int Ox = (this.x - translateX) * ZOOM_OF_CELL;
        int Oy = (this.y - translateY) * ZOOM_OF_CELL;
